...
void loop()
{
  Serial.println("Press 1 for add and Press 2 for verify");
...
void verify()                     // run over and over again
{
//  finger.getTemplateCount();
//
//  if (finger.templateCount == 0) 
//  {
//    Serial.print("Sensor doesn't contain any fingerprint data. Please run the 'Add Fingerprint Program");
//  }
//  else 
//  {
